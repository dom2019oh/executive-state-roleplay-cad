      ...
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', padding: '0 80px', gap: 48 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 28, maxWidth: 400 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 14 }}>
            ...
            <h1 style={{ fontSize: 36, fontWeight: 800, color: '#ffffff', margin: 0, letterSpacing: '-0.02em', textShadow: '0 2px 12px rgba(0,0,0,0.4)', lineHeight: 1.1 }}>
              Executive State CAD
            </h1>
            <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.85)', margin: 0, lineHeight: 1.6, fontWeight: 500 }}>
